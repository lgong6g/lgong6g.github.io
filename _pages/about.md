...
Hi! I am a Steward Observatory Prize Fellow in Cosmological Data Analysis working in the [Arizona Cosmology Lab (ACL)](https://cosmolab.arizona.edu). I obtained my PhD degree from [Universitäts-Sternwarte München (USM)](https://www.physik.lmu.de/observatory/de/) and [Max Planck Institute for extraterrestrial Physics (MPE)](https://www.mpe.mpg.de/main), Germany in 2025. My researches mainly focus on weak gravitational lensing, large-scale structure in the Universe and machine learning (ML) applications to cosmology. My PhD supervisors are [Prof. Dr. Ralf Bender](https://www.mpe.mpg.de/~bender/) and [Dr. Stella Seitz](https://www.usm.lmu.de/~stella/stella.html). I am a member of the [Dark Energy Survey](https://www.darkenergysurvey.org) (DES), the [Dark Energy Spectroscopic Instrument](https://www.desi.lbl.gov) (DESI) and [Nancy Grace Roman Space Telescope](https://science.nasa.gov/mission/roman-space-telescope/) 
